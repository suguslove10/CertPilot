/**
 * CertPilot Design System v2.0
 * Modern, clean, and minimalist design with exceptional user experience
 * Focusing on accessibility, simplicity and visual hierarchy
 */
...
// Shadows (with reduced intensity for a cleaner look)
...
export const transitions = {
  ...
  entrance: 'all 0.25s cubic-bezier(0, 0, 0.2, 1)',
...
export const accessibility = {
  focusRing: {
    default: `0 0 0 3px ${colors.primary[400]}`,
    error: `0 0 0 3px ${colors.error[400]}`,
  },
  contrast: {
