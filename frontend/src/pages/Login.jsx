...
const Login = () => {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <div className={`max-w-md w-full space-y-8 transition-all duration-500 transform ${animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-100 dark:bg-blue-900 mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-blue-600 dark:text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mt-8 border border-gray-100 dark:border-gray-700 backdrop-blur-sm">
          {error && (
            <AlertBanner
              type="error"
              message={error}
        ...
        <div className="flex justify-center items-center space-x-8 mt-8">
          <div className="text-gray-500 dark:text-gray-400 flex items-center text-sm">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1.5 text-blue-600 dark:text-blue-400" viewBox="0 0 20 20" fill="currentColor">
