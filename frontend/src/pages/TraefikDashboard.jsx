...
const TraefikDashboard = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {/* Certificate Management Quick Access Card */}
      <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg shadow-md mb-8">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
          <div>
            <h3 className="text-xl font-semibold text-blue-800 mb-2">SSL Certificate Management with Traefik</h3>
            <p className="text-blue-700 mb-4">
              Quickly issue and manage SSL certificates using Traefik's automatic HTTPS support.
            </p>
            <ul className="list-disc pl-5 text-blue-600 mb-4">
              <li>Issue certificates for subdomains</li>
              <li>Issue certificates for main domains</li>
              <li>Configure application ports</li>
              <li>Manage existing certificates</li>
            </ul>
          </div>
          <div className="mt-4 md:mt-0">
            <Link 
              to="/traefik-certificates" 
              className="bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-lg font-medium shadow-sm inline-block transition-colors"
            >
              Manage Traefik SSL Certificates →
            </Link>
          </div>
        </div>
      </div>
