...
if (process.env.CLOUDFLARE_API_TOKEN) {
  ...
  app.get('/api/cloudflare/zones/:zoneId/dns-records', async (req, res) => {
    try {
      const { zoneId } = req.params;
      const result = await cloudflareService.listDnsRecords(process.env.CLOUDFLARE_API_TOKEN, zoneId);
      res.json(result);
    } catch (error) {
